...
const client_id = process.env.CLIENT_ID || credentials.client_id;
const client_secret = process.env.CLIENT_SECRET || credentials.client_secret;
const scope = "data:read_write";

const host = "localhost"
const port = process.env.PORT || 3000;

const state_tasks = new Map();
